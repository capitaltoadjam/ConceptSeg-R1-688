...
[![Stars](https://img.shields.io/github/stars/yuanzhao-CVLAB/ConceptSeg-R1?style=flat-square)](https://github.com/capitaltoadjam/ConceptSeg-R1-688/stargazers)
...
```bash
git clone https://github.com/capitaltoadjam/ConceptSeg-R1-688.git
cd ConceptSeg-R1-688
python setup.py
```
...
<!-- Last updated: 2026-06-06 20:00:48 -->
